...
class PasswordWidget(customtkinter.CTkFrame):
    def __init__(self, master=None, app=None):
        ...
        self.view_button = customtkinter.CTkButton(self.right_frame, text="View", command=app.view_pass, width=50)
        self.view_button.grid(row=0, column=1, padx=(20, 0), pady=20, sticky="nsew")

        self.edit_button = customtkinter.CTkButton(self.right_frame, text="Edit", command=app.edit_pass, width=50)
        self.edit_button.grid(row=0, column=2, padx=5, pady=20, sticky="nsew")

        self.delete_button = customtkinter.CTkButton(self.right_frame, text="Delete", command=app.delete_pass, width=50)
        self.delete_button.grid(row=0, column=3, padx=(0, 20), pady=20, sticky="nsew")


        # Bottom frame
        self.add_button = customtkinter.CTkButton(self, text="Añadir", command=app.add_pass, width=75)
