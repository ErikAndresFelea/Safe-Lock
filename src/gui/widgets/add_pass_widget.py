...
class AddPasswordWidget(customtkinter.CTkFrame):
    def __init__(self, master=None):
        ...
        self.edit_button = customtkinter.CTkButton(self, text="Añadir", command=self.addPass, width=50)
        self.edit_button.grid(row=5, column=0, padx=5, pady=0)

        self.cancel_button = customtkinter.CTkButton(self, text="Cancelar", command=self.cancelAdd, width=50)
