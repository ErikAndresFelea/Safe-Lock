...
class ViewPasswordWidget(ctk.CTkFrame):
    def __init__(self, master: ctk.CTk, app: App, id: str):
        ...
        title_label = ctk.CTkLabel(self, text=f"{self.__password_data[1]}", font=ctk.CTkFont(size=40, weight="bold", family="Verdana"))
        ...
        name_label_click = ctk.CTkLabel(form_frame, text=self.__password_data[1], cursor="hand2")
        ...
        user_name_label_click = ctk.CTkLabel(form_frame, text=self.__password_data[2], cursor="hand2")
        ...
        password_label_click = ctk.CTkLabel(form_frame, text=self.__password_data[3], cursor="hand2")
        ...
        email_text = "-" if len(self.__password_data[4]) == 0 else self.__password_data[4]
        ...
        id_text = "-" if len(self.__password_data[5]) == 0 else self.__password_data[5]
        ...
        url_text = "-" if len(self.__password_data[6]) == 0 else self.__password_data[6]
